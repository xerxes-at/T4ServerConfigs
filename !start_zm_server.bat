...
:server
start /wait /abovenormal bin\plutonium-bootstrapper-win32.exe t4sp "%gamepath%" -dedicated +set zombiemode 1 +set key %key% +set fs_game %mod% +sv_config %cfg% +set net_port %port%
